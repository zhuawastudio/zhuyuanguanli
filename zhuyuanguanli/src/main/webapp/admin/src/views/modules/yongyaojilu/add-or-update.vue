    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yaopinId" name="yaopinId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="数量" prop="yongyaojiluNumber">
                       <el-input v-model="ruleForm.yongyaojiluNumber"
                                 placeholder="数量" clearable  :readonly="ro.yongyaojiluNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="数量" prop="yongyaojiluNumber">
                           <el-input v-model="ruleForm.yongyaojiluNumber"
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="日期" prop="yongyaojiluTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd"
                                v-model="ruleForm.yongyaojiluTime"
                                type="date"
                                placeholder="日期"
                                :disabled="ro.yongyaojiluTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yongyaojiluTime" label="日期" prop="yongyaojiluTime">
                            <span v-html="ruleForm.yongyaojiluTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
        ...
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    yaopinId: false,
                    yongyaojiluNumber: false,
                    yongyaojiluTime: false,
                    yishengId: false,
                },
                ruleForm: {
                    yonghuId: '',
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`yongyaojilu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yongyaojiluCrossAddOrUpdateFlag = false;
                                        this.parent.search();
