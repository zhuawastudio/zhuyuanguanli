    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="诊断编号" prop="bingliUuidNumber">
                       <el-input v-model="ruleForm.bingliUuidNumber"
                                 placeholder="诊断编号" clearable  :readonly="ro.bingliUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="诊断编号" prop="bingliUuidNumber">
                           <el-input v-model="ruleForm.bingliUuidNumber"
                                     placeholder="诊断编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="诊断名称" prop="bingliName">
                       <el-input v-model="ruleForm.bingliName"
                                 placeholder="诊断名称" clearable  :readonly="ro.bingliName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="诊断名称" prop="bingliName">
                           <el-input v-model="ruleForm.bingliName"
                                     placeholder="诊断名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="病情" prop="bingliBingqing">
                       <el-input v-model="ruleForm.bingliBingqing"
                                 placeholder="病情" clearable  :readonly="ro.bingliBingqing"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="病情" prop="bingliBingqing">
                           <el-input v-model="ruleForm.bingliBingqing"
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.bingliFile" label="诊断附件" prop="bingliFile">
                        <file-upload
                                tip="点击上传诊断附件"
                                action="file/upload"
                                :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.bingliFile" label="诊断附件" prop="bingliFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="ruleForm.bingliFile"  >诊断附件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="日期" prop="bingliTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd"
                                v-model="ruleForm.bingliTime"
                                type="date"
                                placeholder="日期"
                                :disabled="ro.bingliTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.bingliTime" label="日期" prop="bingliTime">
                            <span v-html="ruleForm.bingliTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   bingliName: [
                              { required: true, message: '诊断名称不能为空', trigger: 'blur' },
                          ],
                   yonghuId: [
                   ...
                   bingliFile: [
                              { required: true, message: '诊断附件不能为空', trigger: 'blur' },
                          ],
                   bingliTime: [
