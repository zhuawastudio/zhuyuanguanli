    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="主要药效" prop="yaopinZuoyong">
                       <el-input v-model="ruleForm.yaopinZuoyong"
                                 placeholder="主要药效" clearable  :readonly="ro.yaopinZuoyong"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="主要药效" prop="yaopinZuoyong">
                           <el-input v-model="ruleForm.yaopinZuoyong"
                                     placeholder="主要药效" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="副作用" prop="fuzuoyong">
                       <el-input v-model="ruleForm.fuzuoyong"
                                 placeholder="副作用" clearable  :readonly="ro.fuzuoyong"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="副作用" prop="fuzuoyong">
                           <el-input v-model="ruleForm.fuzuoyong"
                                     placeholder="副作用" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="药品详情" prop="yaopinContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yaopinZuoyong: [
                              { required: true, message: '主要药效不能为空', trigger: 'blur' },
                          ],
                   fuzuoyong: [
                              { required: true, message: '副作用不能为空', trigger: 'blur' },
                          ],
                   yaopinNewMoney: [
